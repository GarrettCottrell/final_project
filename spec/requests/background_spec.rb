...
describe 'Backgrounds endpoint' do
  it 'Backgrounds endpoint returns json' do
    ...
    expect(background[:data][:attributes][:image_url]).to eq("https://images.unsplash.com/photo-1600041161228-519e6dd27bac?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MXwxOTk0MDh8MHwxfHNlYXJjaHwxfHxEZW52ZXIsQ098ZW58MHx8fA&ixlib=rb-1.2.1&q=80&w=1080")
    ...
    expect(background[:data][:attributes][:credit]).to eq('Photo by Michael Kilcoyne / Unsplash')
  end
end
